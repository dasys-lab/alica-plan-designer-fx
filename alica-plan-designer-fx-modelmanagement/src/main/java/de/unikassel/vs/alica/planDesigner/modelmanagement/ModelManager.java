        ...
        try {
            ...
            if (attribute.equals("name")) {
                ...
                if (!ending.equals("")) {
                    ...
                    // Delete old and generate new autoGeneratedFiles
                    if(oldName != newName) {
                        PlanElement oldPlanElement = planElement;
                        boolean value = false;
                        oldPlanElement.setName(oldValue.toString());
                        List<File> fileList = getGeneratedFilesForAbstractPlan((AbstractPlan) oldPlanElement);
                        ...
                        //Generated only Files if they are exists before
                        if(value){
                            generateAutoGeneratedFilesForAbstractPlan((AbstractPlan) planElement);
                        }
                    }
                }
            }
