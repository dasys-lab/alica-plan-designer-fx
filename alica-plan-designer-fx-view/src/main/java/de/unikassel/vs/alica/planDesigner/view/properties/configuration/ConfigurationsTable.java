...
public abstract class ConfigurationsTable<S extends ViewModelElement> extends VBox {
    ...
    public <T> void addColumn(String title, String propertyName, StringConverter<T> converter, boolean editable, ConfigurationsTab.ConfigurationsTableListener listener) {
        listener.setPropertyName(propertyName);
        table.addColumn(title, propertyName, converter, editable, listener);
    }
