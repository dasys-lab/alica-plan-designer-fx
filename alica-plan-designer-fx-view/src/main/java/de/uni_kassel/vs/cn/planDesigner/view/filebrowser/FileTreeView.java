...
//                }
    ...
    public void addTreeViewModelElement(TreeViewModelElement behaviour) {
        ...
        if (folder != null) {
            File file = Paths.get(plansPath,behaviour.getDestinationPath(), behaviour.getName(), ".beh").toFile();
