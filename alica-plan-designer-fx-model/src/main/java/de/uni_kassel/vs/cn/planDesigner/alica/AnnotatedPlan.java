 ...
 * <ul>
 *   <li>{@link alica.AnnotatedPlan#getPlan <em>Plan</em>}</li>
 *   <li>{@link alica.AnnotatedPlan#isActivated <em>Activated</em>}</li>
 * </ul>
 * </p>
 *
 * @see alica.AlicaPackage#getAnnotatedPlan()
 * @model
 * @generated
 */
public interface AnnotatedPlan extends PlanElement {
	 ...
	 * @see #setPlan(Plan)
	 * @see alica.AlicaPackage#getAnnotatedPlan_Plan()
	 * @model
	 * @generated
	 */
	Plan getPlan();
	...
	/**
	 * Sets the value of the '{@link alica.AnnotatedPlan#getPlan <em>Plan</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see alica.AlicaPackage#getAnnotatedPlan_Activated()
	 * @model default="true"
	 * @generated
	 */
	boolean isActivated();
	...
	/**
	 * Sets the value of the '{@link alica.AnnotatedPlan#isActivated <em>Activated</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
