 ...
 * <ul>
 *   <li>{@link alica.EntryPoint#getTask <em>Task</em>}</li>
 *   <li>{@link alica.EntryPoint#isSuccessRequired <em>Success Required</em>}</li>
 *   <li>{@link alica.EntryPoint#getState <em>State</em>}</li>
 *   <li>{@link alica.EntryPoint#getMinCardinality <em>Min Cardinality</em>}</li>
 *   <li>{@link alica.EntryPoint#getMaxCardinality <em>Max Cardinality</em>}</li>
 *   <li>{@link alica.EntryPoint#getPlan <em>Plan</em>}</li>
 * </ul>
 * </p>
 *
 * @see alica.AlicaPackage#getEntryPoint()
 * @model
 * @generated
 */
public interface EntryPoint extends IInhabitable {
	 ...
	 * @see #setTask(Task)
	 * @see alica.AlicaPackage#getEntryPoint_Task()
	 * @model required="true"
	 * @generated
	 */
	Task getTask();
	...
	/**
	 * Sets the value of the '{@link alica.EntryPoint#getTask <em>Task</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see alica.AlicaPackage#getEntryPoint_SuccessRequired()
	 * @model default="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link alica.EntryPoint#isSuccessRequired <em>Success Required</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link alica.State#getEntryPoint <em>Entry Point</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setState(State)
	 * @see alica.AlicaPackage#getEntryPoint_State()
	...
	/**
	 * Sets the value of the '{@link alica.EntryPoint#getState <em>State</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see alica.AlicaPackage#getEntryPoint_MinCardinality()
	...
	/**
	 * Sets the value of the '{@link alica.EntryPoint#getMinCardinality <em>Min Cardinality</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see alica.AlicaPackage#getEntryPoint_MaxCardinality()
	...
	/**
	 * Sets the value of the '{@link alica.EntryPoint#getMaxCardinality <em>Max Cardinality</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link alica.Plan#getEntryPoints <em>Entry Points</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setPlan(Plan)
	 * @see alica.AlicaPackage#getEntryPoint_Plan()
	...
	/**
	 * Sets the value of the '{@link alica.EntryPoint#getPlan <em>Plan</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
